...
export const getComputerMove = (gameBoard) => {
    let moveChecks = [
        { //for columns
            indexes: [0,4,8,12], //will start from first column
            step: 1, //increment in index values by
            max: 4 
        },
        { //for rows
            indexes: [0,1,2,3], //will start from first row
            step: 4, //increment in index values by
            max: 16 
        },
        {
            indexes: [0,5,10,15],
